...
const TRASH_DICT = {
    "Nhựa":        { name:"Nhựa",        action:"Bỏ Thùng Vàng",          color:"#00d4ff", icon:"🧴", wiki:"Nhựa",
                     speak:"Nhựa. Vui lòng bỏ vào thùng màu vàng.", points:10,
                     ...
                     tip:"♻️ 1 chai nhựa tái chế = tiết kiệm đủ điện để chạy bóng đèn 6 tiếng!", risk:"Thấp" },
    "Giấy":        { name:"Giấy",        action:"Bỏ Thùng Xanh Dương",    color:"#ff8c00", icon:"📄", wiki:"Giấy",
                     speak:"Giấy. Vui lòng bỏ vào thùng màu xanh dương.", points:8,
                     ...
                     tip:"🌳 Tái chế 1 tấn giấy = cứu 17 cây xanh và 26.000 lít nước!", risk:"Thấp" },
    "Kim Loại":    { name:"Kim Loại",    action:"Bỏ Thùng Vàng",          color:"#c0c8e0", icon:"🔩", wiki:"Kim_loại",
                     speak:"Kim loại. Vui lòng bỏ vào thùng màu vàng.", points:15,
                     ...
                     tip:"⚡ Tái chế 1 lon nhôm tiết kiệm điện bằng xem TV 3 tiếng!", risk:"Thấp" },
    "Thủy Tinh":   { name:"Thủy Tinh",  action:"Cẩn thận, Bỏ Thùng Vàng",color:"#a0c8ff", icon:"🍾", wiki:"Thủy_tinh",
                     speak:"Thủy tinh. Cẩn thận rơi vỡ, bỏ vào thùng vàng.", points:12,
                     ...
                     tip:"🔄 Thủy tinh là vật liệu tái chế hoàn hảo nhất — không bao giờ giảm chất lượng!", risk:"Trung bình" },
    "Rác Điện Tử": { name:"Rác Điện Tử",action:"Thu Gom Riêng",           color:"#ff3d5a", icon:"📱", wiki:"Rác_thải_điện_tử",
                     speak:"Cảnh báo. Rác điện tử nguy hại, cần thu gom riêng.", points:20,
                     ...
                     tip:"☠️ Pin và vi mạch chứa chì, thủy ngân — gây ung thư nếu thấm vào đất nước!", risk:"Rất cao" },
    "Rác Hữu Cơ":  { name:"Rác Hữu Cơ", action:"Bỏ Thùng Xanh Lá",      color:"#00e87a", icon:"🍃", wiki:"Chất_thải_hữu_cơ",
                     speak:"Rác hữu cơ. Vui lòng bỏ vào thùng xanh lá.", points:5,
                     ...
                     tip:"🌱 Rác hữu cơ ủ thành phân compost = phân bón tự nhiên siêu tốt cho cây!", risk:"Thấp" },
    "Rác Vô Cơ":   { name:"Rác Vô Cơ",  action:"Bỏ Thùng Đỏ",           color:"#4d8cff", icon:"🗑️", wiki:"Rác_thải",
                     speak:"Rác vô cơ sinh hoạt. Vui lòng bỏ thùng đỏ.", points:3,
                     ...
                     tip:"💡 Thay thế đồ nhựa dùng một lần bằng sản phẩm tái sử dụng để giảm rác vô cơ!", risk:"Thấp" }
};
...
function addPoints(key, conf) {
    ...
    const earned     = info.points + confBonus + streakBonus;
    totalPoints += earned;
    return { earned, base: info.points, confBonus, streakBonus };
}
...
const REWARDS = {
  voucher: [
    { id:"v1", icon:"☕", name:"Cà phê miễn phí",       cost:80,  desc:"1 ly cà phê size M tại căng tin trường hoặc đối tác tham gia.",    tag:"Phổ biến" },
    { id:"v2", icon:"🧋", name:"Trà sữa 1/2 giá",        cost:60,  desc:"Giảm 50% cho 1 ly trà sữa bất kỳ tại chuỗi đối tác.",            tag:"Hot" },
    { id:"v3", icon:"🍕", name:"Voucher ăn uống 20K",    cost:120, desc:"Phiếu giảm giá 20.000đ tại căng tin hoặc quán ăn đối tác.",       tag:"" },
    { id:"v4", icon:"🚲", name:"Thuê xe đạp miễn phí",   cost:50,  desc:"1 lượt thuê xe đạp công cộng trong khuôn viên trường, miễn phí.", tag:"" },
    { id:"v5", icon:"🖨️", name:"In 20 trang miễn phí",   cost:40,  desc:"20 tờ A4 in đen trắng miễn phí tại phòng in của trường.",          tag:"Tiện ích" },
    { id:"v6", icon:"🎬", name:"Vé xem phim -30%",       cost:150, desc:"Giảm 30% vé xem phim bất kỳ tại rạp đối tác cuối tuần.",          tag:"Cuối tuần" },
  ],
  item: [
    { id:"i1", icon:"🎒", name:"Túi vải tái chế SmartBin", cost:200, desc:"Túi canvas in logo SmartBin, thân thiện môi trường, dùng thay túi nilon.", tag:"Eco" },
    { id:"i2", icon:"🖊️", name:"Bút làm từ giấy tái chế",  cost:80,  desc:"Bút bi thân giấy tái chế, mực xanh hoặc đen tuỳ chọn.",         tag:"" },
    { id:"i3", icon:"🌿", name:"Hạt giống trồng cây nhỏ",  cost:100, desc:"Gói hạt giống rau thơm (húng quế, hành, cà chua bi) để trồng tại nhà.", tag:"Xanh" },
    { id:"i4", icon:"🧴", name:"Bình nước giữ nhiệt",      cost:350, desc:"Bình giữ nhiệt 500ml in logo SmartBin, không dùng chai nhựa nữa!", tag:"Premium" },
    { id:"i5", icon:"📓", name:"Sổ tay giấy tái chế",      cost:160, desc:"Sổ tay bìa cứng, ruột giấy tái chế 96 trang, kẻ ngang.",         tag:"" },
  ],
  eco: [
    { id:"e1", icon:"🌳", name:"Trồng 1 cây xanh",       cost:300, desc:"Điểm của bạn tài trợ trồng 1 cây tại rừng phòng hộ — bạn nhận chứng chỉ điện tử.", tag:"Ý nghĩa" },
    { id:"e2", icon:"🐠", name:"Dọn rác biển 1m²",       cost:150, desc:"Đóng góp vào chiến dịch làm sạch bãi biển, bạn nhận badge 'Người Bảo Vệ Đại Dương'.", tag:"" },
    { id:"e3", icon:"⚡", name:"1 kWh điện tái tạo",     cost:200, desc:"Tài trợ sản xuất 1 kWh điện từ năng lượng mặt trời cho cộng đồng.", tag:"Sáng tạo" },
    { id:"e4", icon:"🐝", name:"Bảo vệ tổ ong tự nhiên", cost:120, desc:"Hỗ trợ dự án nuôi ong tự nhiên, nhận nhãn 'Người Bạn Của Ong'.",   tag:"Dễ thương" },
  ],
  special: [
    { id:"s1", icon:"🏅", name:"Huy hiệu Chiến Binh Xanh", cost:500, desc:"NFT huy hiệu kỹ thuật số độc quyền 'Chiến Binh Xanh PTIT' — cấp số lượng có hạn!", tag:"Độc quyền" },
    { id:"s2", icon:"🎓", name:"+0.1 điểm rèn luyện",      cost:400, desc:"Cộng 0.1 vào điểm rèn luyện học kỳ (có xác nhận của Đoàn Trường).", tag:"Học sinh" },
    { id:"s3", icon:"📸", name:"Khung ảnh Profile Xanh",    cost:80,  desc:"Bộ filter ảnh đại diện 'SmartBin Champion' dùng trên MXH.",        tag:"Trend" },
    { id:"s4", icon:"🌏", name:"Tên lên Bảng Danh Dự",      cost:250, desc:"Tên bạn sẽ xuất hiện trên bảng Anh Hùng Môi Trường tại khuôn viên.", tag:"Vinh danh" },
  ]
};
...
function detectMotion(canvas) {
    ...
    if (!prevFrameData || prevFrameData.length !== curr.length) {
        prevFrameData = curr.slice(); return 0;
    }
...
ENDOFFILE
echo "Script done, lines: $(wc -l < /home/claude/script_clean.js)"
